...
from Tou.settings import MEDIA_URL,STATIC_URL
...
def ueditorAll(content,name):
    ...
    <script type="text/plain" id="id_%s" style="width:100%%" name="%s">%s</script><script type="text/javascript">
            ...
            editor.render('id_%s');
        </script>'''%(STATIC_URL,STATIC_URL,STATIC_URL,STATIC_URL,name,name,(content.value() and [content.value()] or [''])[0],name)
    return html
...
def ueditorReplay(content,name):
    ...
    <script type="text/plain" id="u_editor" style="width:100%%" name="%s">%s</script><script type="text/javascript">
        ...
        </script>'''%(STATIC_URL,STATIC_URL,STATIC_URL,STATIC_URL,name,content)
    return html